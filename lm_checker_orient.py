...
for mask_file_name in mask_file_list:
	...
	output_file.write('#Top 1 hits: ' + str(curr_top1_hits) + '\t' + str(float(curr_top1_hits/curr_num_questions)) + '\n')
	output_file.write('#Top 2 hits: ' + str(curr_top2_hits) + '\t' + str(float(curr_top2_hits/curr_num_questions)) + '\n')
	...
	output_file.close()
	print(str(float(curr_top1_hits/curr_num_questions)))
	print(str(float(curr_top2_hits/curr_num_questions)))
...
print ('#Top 1 hits: ' + str(overall_top1_hits) + '\t' + str(float(overall_top1_hits/total_num_questions)) + '\n')
print ('#Top 2 hits: ' + str(overall_top2_hits) + '\t' + str(float(overall_top2_hits/total_num_questions)) + '\n')
